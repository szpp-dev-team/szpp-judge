...
import { Clarification, Clarification_Answer, Contest, MutationTask, MutationTestcase, MutationTestcaseSet, StandingsElement, Task, Testcase, TestcaseSet, User } from "./resources_pb";
