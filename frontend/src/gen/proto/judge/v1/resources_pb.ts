...
export enum JudgeStatus {
  ...
  /**
   * @generated from enum value: TLE = 6;
   */
  TLE = 6,

  /**
   * @generated from enum value: WA = 7;
   */
  WA = 7,
}
...
export class ExecutionResultDetail extends Message<ExecutionResultDetail> {
  ...
  /**
   * stdout が巨大すぎて省略した場合は true
   *
   * @generated from field: bool stdout_omitted = 5;
   */
  stdoutOmitted = false;

  /**
   * stderr が巨大すぎて省略した場合は true
   *
   * @generated from field: bool stderr_omitted = 6;
   */
  stderrOmitted = false;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "stdout_omitted", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 6, name: "stderr_omitted", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
