/*
 * Original source:
 *   https://github.com/yos1up/scratch2cpp/blob/eaa59832f752fbbf665b77e59567a9eec6670c21/web/crx/main.js
 *   https://github.com/yos1up/scratch2cpp/blob/eaa59832f752fbbf665b77e59567a9eec6670c21/web/crx/sb3_to_cpp.js
 */
...
`;
    ...
    for (let varID in variables) {
      ...
      variableDeclareSource += "Var " + this.modifyVariableName(name) + "("
        + Sb3ToCppConverter.processLiteral(initialValue) + ");\n";
    }
      ...
      try {
        ...
        switch (opcode) {
          ...
          case "control_repeat":
            ...
            snippet =
              `for (int ${cntName}=0;${cntName}<${
                this.processValueInfo(blockInfo["inputs"]["TIMES"], allBlocksInfo)
              }.asNumber();${cntName}++){\n` + Sb3ToCppConverter.indent(innerSnippet, 4) + "}\n";
            break;
  ...
  static processLiteral(obj) {
    ...
    if (typeof obj == "string") {
      /*
            ...
            */
      if (!isFinite(obj) && !isNaN(obj) && "" + Number(obj) === obj) { // 標準的な記法かのチェック
