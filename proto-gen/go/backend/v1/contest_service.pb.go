...
var file_backend_v1_contest_service_proto_rawDesc = []byte{
	...
	0x22, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x6f, 0x6e, 0x74,
	0x65, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x70, 0x72,
	...
	0x64, 0x69, 0x6e, 0x67, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xac, 0x04, 0x0a, 0x0e, 0x43, 0x6f,
	...
	0x2e, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2e, 0x76, 0x31, 0x42, 0x13, 0x43, 0x6f, 0x6e,
	0x74, 0x65, 0x73, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var file_backend_v1_contest_service_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_backend_v1_contest_service_proto_goTypes = []interface{}{
	...
	(*Contest)(nil),                         // 13: backend.v1.Contest
	(*ContestTask)(nil),                     // 14: backend.v1.ContestTask
	(*SubmissionStatus)(nil),                // 15: backend.v1.SubmissionStatus
	(*StandingsElement)(nil),                // 16: backend.v1.StandingsElement
}
var file_backend_v1_contest_service_proto_depIdxs = []int32{
	12, // 0: backend.v1.CreateContestRequest.start_at:type_name -> google.protobuf.Timestamp
	12, // 1: backend.v1.CreateContestRequest.end_at:type_name -> google.protobuf.Timestamp
	13, // 2: backend.v1.CreateContestResponse.contest:type_name -> backend.v1.Contest
	13, // 3: backend.v1.GetContestResponse.contest:type_name -> backend.v1.Contest
	13, // 4: backend.v1.ListContestsResponse.contests:type_name -> backend.v1.Contest
	14, // 5: backend.v1.ListContestTasksResponse.tasks:type_name -> backend.v1.ContestTask
	15, // 6: backend.v1.GetMySubmissionStatusesResponse.submission_statuses:type_name -> backend.v1.SubmissionStatus
	16, // 7: backend.v1.GetStandingsResponse.standings_list:type_name -> backend.v1.StandingsElement
	...
	1,  // 14: backend.v1.ContestService.CreateContest:output_type -> backend.v1.CreateContestResponse
	3,  // 15: backend.v1.ContestService.GetContest:output_type -> backend.v1.GetContestResponse
	5,  // 16: backend.v1.ContestService.ListContests:output_type -> backend.v1.ListContestsResponse
	7,  // 17: backend.v1.ContestService.ListContestTasks:output_type -> backend.v1.ListContestTasksResponse
	9,  // 18: backend.v1.ContestService.GetMySubmissionStatuses:output_type -> backend.v1.GetMySubmissionStatusesResponse
	11, // 19: backend.v1.ContestService.GetStandings:output_type -> backend.v1.GetStandingsResponse
