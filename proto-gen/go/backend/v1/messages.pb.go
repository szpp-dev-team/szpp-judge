...
func (x *GetContestRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type GetStandingsResponse struct {
	...
	StandingsList []*PersonalStandings `protobuf:"bytes,1,rep,name=standings_list,json=standingsList,proto3" json:"standings_list,omitempty"`
}
...
func (x *GetStandingsResponse) GetStandingsList() []*PersonalStandings {
	if x != nil {
...
var file_backend_v1_messages_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x73, 0x74, 0x22, 0x3b, 0x0a, 0x11, 0x47, 0x65,
	...
	0x49, 0x64, 0x22, 0x5c, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x6e, 0x64, 0x69, 0x6e,
	0x67, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x44, 0x0a, 0x0e, 0x73, 0x74,
	...
	0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x53, 0x74, 0x61, 0x6e, 0x64, 0x69, 0x6e, 0x67,
	0x73, 0x52, 0x0d, 0x73, 0x74, 0x61, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x73, 0x4c, 0x69, 0x73, 0x74,
...
var file_backend_v1_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_backend_v1_messages_proto_goTypes = []interface{}{
	...
	(*User)(nil),                  // 18: backend.v1.User
	(*timestamppb.Timestamp)(nil), // 19: google.protobuf.Timestamp
	(*Contest)(nil),               // 20: backend.v1.Contest
	(*PersonalStandings)(nil),     // 21: backend.v1.PersonalStandings
}
var file_backend_v1_messages_proto_depIdxs = []int32{
	18, // 0: backend.v1.GetUserResponse.user:type_name -> backend.v1.User
	18, // 1: backend.v1.CreateUserResponse.user:type_name -> backend.v1.User
	18, // 2: backend.v1.LoginResponse.user:type_name -> backend.v1.User
	19, // 3: backend.v1.CreateContestRequest.start_at:type_name -> google.protobuf.Timestamp
	19, // 4: backend.v1.CreateContestRequest.end_at:type_name -> google.protobuf.Timestamp
	20, // 5: backend.v1.CreateContestResponse.contest:type_name -> backend.v1.Contest
	20, // 6: backend.v1.GetContestResponse.contest:type_name -> backend.v1.Contest
	20, // 7: backend.v1.ListContestsResponse.contests:type_name -> backend.v1.Contest
	21, // 8: backend.v1.GetStandingsResponse.standings_list:type_name -> backend.v1.PersonalStandings
