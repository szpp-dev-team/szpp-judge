...
var file_backend_v1_messages_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0xaf, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d,
...
var file_backend_v1_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_backend_v1_messages_proto_goTypes = []interface{}{
	...
	(*User)(nil),               // 10: backend.v1.User
}
var file_backend_v1_messages_proto_depIdxs = []int32{
	10, // 0: backend.v1.GetUserResponse.user:type_name -> backend.v1.User
	10, // 1: backend.v1.CreateUserResponse.user:type_name -> backend.v1.User
	10, // 2: backend.v1.LoginResponse.user:type_name -> backend.v1.User
