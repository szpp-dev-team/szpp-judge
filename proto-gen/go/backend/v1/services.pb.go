...
var file_backend_v1_services_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x32, 0xbc, 0x01, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x73, 0x74, 0x53,
	...
	0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x73, 0x74, 0x12, 0x20, 0x2e,
	0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63,
	0x68, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x21, 0x2e, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x61,
	0x72, 0x63, 0x68, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x42, 0xaf, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x62, 0x61, 0x63, 0x6b, 0x65,
	0x6e, 0x64, 0x2e, 0x76, 0x31, 0x42, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x50,
...
var file_backend_v1_services_proto_goTypes = []interface{}{
	...
	(*SearchContestRequest)(nil),  // 6: backend.v1.SearchContestRequest
	(*GetUserResponse)(nil),       // 7: backend.v1.GetUserResponse
	(*CreateUserResponse)(nil),    // 8: backend.v1.CreateUserResponse
	(*LoginResponse)(nil),         // 9: backend.v1.LoginResponse
	(*LogoutResponse)(nil),        // 10: backend.v1.LogoutResponse
	(*PingResponse)(nil),          // 11: backend.v1.PingResponse
	(*CreateContestResponse)(nil), // 12: backend.v1.CreateContestResponse
...
var file_backend_v1_services_proto_depIdxs = []int32{
	...
	6,  // 6: backend.v1.ContestService.SearchContest:input_type -> backend.v1.SearchContestRequest
	7,  // 7: backend.v1.UserService.GetUser:output_type -> backend.v1.GetUserResponse
	8,  // 8: backend.v1.UserService.CreateUser:output_type -> backend.v1.CreateUserResponse
	9,  // 9: backend.v1.AuthService.Login:output_type -> backend.v1.LoginResponse
	10, // 10: backend.v1.AuthService.Logout:output_type -> backend.v1.LogoutResponse
	11, // 11: backend.v1.HealthcheckService.Ping:output_type -> backend.v1.PingResponse
	12, // 12: backend.v1.ContestService.CreateContest:output_type -> backend.v1.CreateContestResponse
	13, // 13: backend.v1.ContestService.SearchContest:output_type -> backend.v1.SearchContestResponse
