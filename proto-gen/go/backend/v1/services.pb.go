...
var file_backend_v1_services_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x32, 0xeb, 0x01, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x32, 0x4f, 0x0a, 0x12, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x39, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12, 0x17,
	0x2e, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x69, 0x6e, 0x67,
...
var file_backend_v1_services_proto_goTypes = []interface{}{
	...
	(*PingRequest)(nil),        // 7: backend.v1.PingRequest
...
var file_backend_v1_services_proto_depIdxs = []int32{
	...
	7,  // 7: backend.v1.HealthcheckService.Ping:input_type -> backend.v1.PingRequest
	...
	12, // 12: backend.v1.TaskService.CreateTask:output_type -> backend.v1.CreateTaskResponse
	13, // 13: backend.v1.TaskService.GetTask:output_type -> backend.v1.GetTaskResponse
	14, // 14: backend.v1.TaskService.UpdateTask:output_type -> backend.v1.UpdateTaskResponse
	15, // 15: backend.v1.HealthcheckService.Ping:output_type -> backend.v1.PingResponse
