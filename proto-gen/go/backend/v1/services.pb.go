...
var file_backend_v1_services_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x32, 0xd9, 0x02, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x73, 0x74, 0x53,
	...
	0x65, 0x73, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x51, 0x0a, 0x0c,
...
var file_backend_v1_services_proto_goTypes = []interface{}{
	...
	(*GetStandingsRequest)(nil),   // 8: backend.v1.GetStandingsRequest
	(*GetUserResponse)(nil),       // 9: backend.v1.GetUserResponse
	(*CreateUserResponse)(nil),    // 10: backend.v1.CreateUserResponse
	(*LoginResponse)(nil),         // 11: backend.v1.LoginResponse
	(*LogoutResponse)(nil),        // 12: backend.v1.LogoutResponse
	(*PingResponse)(nil),          // 13: backend.v1.PingResponse
	(*CreateContestResponse)(nil), // 14: backend.v1.CreateContestResponse
	(*GetContestResponse)(nil),    // 15: backend.v1.GetContestResponse
	(*ListContestsResponse)(nil),  // 16: backend.v1.ListContestsResponse
...
var file_backend_v1_services_proto_depIdxs = []int32{
	...
	8,  // 8: backend.v1.ContestService.GetStandings:input_type -> backend.v1.GetStandingsRequest
	9,  // 9: backend.v1.UserService.GetUser:output_type -> backend.v1.GetUserResponse
	10, // 10: backend.v1.UserService.CreateUser:output_type -> backend.v1.CreateUserResponse
	11, // 11: backend.v1.AuthService.Login:output_type -> backend.v1.LoginResponse
	12, // 12: backend.v1.AuthService.Logout:output_type -> backend.v1.LogoutResponse
	13, // 13: backend.v1.HealthcheckService.Ping:output_type -> backend.v1.PingResponse
	14, // 14: backend.v1.ContestService.CreateContest:output_type -> backend.v1.CreateContestResponse
	15, // 15: backend.v1.ContestService.GetContest:output_type -> backend.v1.GetContestResponse
	16, // 16: backend.v1.ContestService.ListContests:output_type -> backend.v1.ListContestsResponse
	17, // 17: backend.v1.ContestService.GetStandings:output_type -> backend.v1.GetStandingsResponse
