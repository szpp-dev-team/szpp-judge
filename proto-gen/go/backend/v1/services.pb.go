...
var file_backend_v1_services_proto_goTypes = []interface{}{
	...
	(*GetUserResponse)(nil),    // 5: backend.v1.GetUserResponse
	(*CreateUserResponse)(nil), // 6: backend.v1.CreateUserResponse
...
var file_backend_v1_services_proto_depIdxs = []int32{
	...
	5, // 5: backend.v1.UserService.GetUser:output_type -> backend.v1.GetUserResponse
	6, // 6: backend.v1.UserService.CreateUser:output_type -> backend.v1.CreateUserResponse
	7, // 7: backend.v1.AuthService.Login:output_type -> backend.v1.LoginResponse
	8, // 8: backend.v1.AuthService.Logout:output_type -> backend.v1.LogoutResponse
	9, // 9: backend.v1.HealthcheckService.Ping:output_type -> backend.v1.PingResponse
