...
type Contest struct {
	...
	Id              int32                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Name            string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"` // ER図から消えていたけどslugをnameとして使うわけではないはず…？
	Slug            string                 `protobuf:"bytes,3,opt,name=slug,proto3" json:"slug,omitempty"`
	Description     string                 `protobuf:"bytes,4,opt,name=description,proto3" json:"description,omitempty"`
	TaskId          int32                  `protobuf:"varint,5,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	ClarificationId int32                  `protobuf:"varint,6,opt,name=clarification_id,json=clarificationId,proto3" json:"clarification_id,omitempty"`
...
func (x *Contest) GetTaskId() int32 {
	if x != nil {
		return x.TaskId
	}
	return 0
...
func (x *Contest) GetClarificationId() int32 {
	if x != nil {
...
var file_backend_v1_resources_proto_rawDesc = []byte{
	...
	0x5f, 0x61, 0x74, 0x22, 0x91, 0x02, 0x0a, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x73, 0x74, 0x12,
	...
	0x49, 0x64, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x6c, 0x61, 0x72, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0f, 0x63, 0x6c,
	0x61, 0x72, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x35, 0x0a,
	...
	0x52, 0x05, 0x65, 0x6e, 0x64, 0x41, 0x74, 0x42, 0xb0, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e,
...
var file_backend_v1_resources_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_backend_v1_resources_proto_depIdxs = []int32{
	...
	2, // 2: backend.v1.Contest.start_at:type_name -> google.protobuf.Timestamp
	2, // 3: backend.v1.Contest.end_at:type_name -> google.protobuf.Timestamp
