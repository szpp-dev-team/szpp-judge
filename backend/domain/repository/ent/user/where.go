...
func HasClarificationsWith(preds ...predicate.Clarification) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasAnsweredClarificationsWith(preds ...predicate.Clarification) predicate.User {
	return predicate.User(func(s *sql.Selector) {
