...
func (su *SubmitUpdate) AddSubmitContestIDs(ids ...int) *SubmitUpdate {
	su.mutation.AddSubmitContestIDs(ids...)
	return su
}

// AddSubmitContests adds the "submit_contests" edges to the Contest entity.
func (su *SubmitUpdate) AddSubmitContests(c ...*Contest) *SubmitUpdate {
	ids := make([]int, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return su.AddSubmitContestIDs(ids...)
}
...
// ClearSubmitContests clears all "submit_contests" edges to the Contest entity.
func (su *SubmitUpdate) ClearSubmitContests() *SubmitUpdate {
	su.mutation.ClearSubmitContests()
	return su
}

// RemoveSubmitContestIDs removes the "submit_contests" edge to Contest entities by IDs.
func (su *SubmitUpdate) RemoveSubmitContestIDs(ids ...int) *SubmitUpdate {
	su.mutation.RemoveSubmitContestIDs(ids...)
	return su
}

// RemoveSubmitContests removes "submit_contests" edges to Contest entities.
func (su *SubmitUpdate) RemoveSubmitContests(c ...*Contest) *SubmitUpdate {
	ids := make([]int, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return su.RemoveSubmitContestIDs(ids...)
}
...
func (su *SubmitUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if su.mutation.SubmitContestsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
	...
	if nodes := su.mutation.RemovedSubmitContestsIDs(); len(nodes) > 0 && !su.mutation.SubmitContestsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   submit.SubmitContestsTable,
	...
	if nodes := su.mutation.SubmitContestsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   submit.SubmitContestsTable,
...
// AddSubmitContestIDs adds the "submit_contests" edge to the Contest entity by IDs.
func (suo *SubmitUpdateOne) AddSubmitContestIDs(ids ...int) *SubmitUpdateOne {
	suo.mutation.AddSubmitContestIDs(ids...)
	return suo
}

// AddSubmitContests adds the "submit_contests" edges to the Contest entity.
func (suo *SubmitUpdateOne) AddSubmitContests(c ...*Contest) *SubmitUpdateOne {
	ids := make([]int, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return suo.AddSubmitContestIDs(ids...)
}
...
// ClearSubmitContests clears all "submit_contests" edges to the Contest entity.
func (suo *SubmitUpdateOne) ClearSubmitContests() *SubmitUpdateOne {
	suo.mutation.ClearSubmitContests()
	return suo
}

// RemoveSubmitContestIDs removes the "submit_contests" edge to Contest entities by IDs.
func (suo *SubmitUpdateOne) RemoveSubmitContestIDs(ids ...int) *SubmitUpdateOne {
	suo.mutation.RemoveSubmitContestIDs(ids...)
	return suo
}

// RemoveSubmitContests removes "submit_contests" edges to Contest entities.
func (suo *SubmitUpdateOne) RemoveSubmitContests(c ...*Contest) *SubmitUpdateOne {
	ids := make([]int, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return suo.RemoveSubmitContestIDs(ids...)
}
...
func (suo *SubmitUpdateOne) sqlSave(ctx context.Context) (_node *Submit, err error) {
	...
	if suo.mutation.SubmitContestsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   submit.SubmitContestsTable,
	...
	if nodes := suo.mutation.RemovedSubmitContestsIDs(); len(nodes) > 0 && !suo.mutation.SubmitContestsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   submit.SubmitContestsTable,
	...
	if nodes := suo.mutation.SubmitContestsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   submit.SubmitContestsTable,
