...
func (cc *ContestCreate) AddUserIDs(ids ...int) *ContestCreate {
	cc.mutation.AddUserIDs(ids...)
	return cc
}

// AddUsers adds the "users" edges to the User entity.
func (cc *ContestCreate) AddUsers(u ...*User) *ContestCreate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
func (cc *ContestCreate) AddClarifications(c ...*ContestClarification) *ContestCreate {
	ids := make([]int, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
