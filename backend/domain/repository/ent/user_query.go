...
func (uq *UserQuery) loadSubmits(ctx context.Context, query *SubmitQuery, nodes []*User, init func(*User), assign func(*User, *Submit)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(user.SubmitsTable)
		s.Join(joinT).On(s.C(submit.FieldID), joinT.C(user.SubmitsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.SubmitsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.SubmitsPrimaryKey[0]))
