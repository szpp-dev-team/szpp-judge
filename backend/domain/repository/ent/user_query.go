...
func (uq *UserQuery) loadContests(ctx context.Context, query *ContestQuery, nodes []*User, init func(*User), assign func(*User, *Contest)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(contest.FieldID), joinT.C(user.ContestsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.ContestsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.ContestsPrimaryKey[0]))
